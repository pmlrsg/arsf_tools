...
Airborne Research Facility (NERC-ARF; formerly ARSF).

Developed by the NERC-ARF Data Analysis Node ([NERC-ARF-DAN](http://nerc-arf-dan.nerc.ac.uk/)) based at Plymouth Marine Laboratory.
